    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.CharField(choices=[('Camera', 'Theia/Camera'), ('Tstat', 'Thermostat'), ('Sensors', 'Hecate/Rhodos'), ('Ls', 'Light Switch'), ('Eco_plus', 'Chronos/Eco+'), ('Iris', 'Iris/Home monitoring/Invisible Guard')], default=('Camera', 'Theia/Camera'), max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Devices',
