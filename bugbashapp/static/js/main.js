    ...
    function create_bug() {
        ...
        $.ajax({
            ...
            success : function(response) {
                ...
                if (response.summary) {
                    var row =
                    $("#userBugTableBody").append(`
                        <tr id="bug-${response.id}">
                            <td class="bugSummary">${response.summary}</td>
                            '<td align="center">
                                <button  class="btn btn-primary" onclick="editBug(${response.id})" data-toggle="modal" data-target="#myModal">EDIT</button>
                             </td>
                             <td align="center">
                                <button class="btn btn-danger form-control" onClick="deleteBug(${response.id})">DELETE</button>
                             </td>
                         </tr>
                         `);
                };
